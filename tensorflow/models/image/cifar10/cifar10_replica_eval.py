...
tf.app.flags.DEFINE_string('eval_dir', '/mnt/cifar10_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/mnt/checkpoint',
...
tf.app.flags.DEFINE_integer('trained_steps', 10000,
                            """How many steps were trained""")
tf.app.flags.DEFINE_integer('checkpointing_step', 1000,
...
def evaluate():
  ...
  with tf.Graph().as_default() as g:
    ...
    training_step = 0
    while True:
      eval_once(saver, summary_writer, top_k_op, summary_op, training_step)
